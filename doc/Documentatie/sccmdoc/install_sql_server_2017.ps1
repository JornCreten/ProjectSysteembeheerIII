...
$SQLBACKUPDIR="C:\MSSQL\BACKUPDIR"
$SQLTEMPDBDIR="C:\MSSQL\TEMPDBDIR"
$SQLTEMPDBLOGDIR="C:\MSSQL\TEMPDBLOGDIR"
$SQLUSERDBLOGDIR="C:\MSSQL\USERDBLOGDIR"
...
write-host "about to install the SQL Server 2017 Cumulative Update..." -nonewline
